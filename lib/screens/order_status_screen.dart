...
class _OrderStatusScreenState extends State<OrderStatusScreen> {
          ...
          SnackBar(
            content: Text(
              lang.isEnglish
                  ...
                  : 'Status pesananmu telah diperbarui!',
  ...
  Future<void> _playNotificationSound() async {
    ...
    FlutterRingtonePlayer().play(
      ...
      volume: 1.0,
      asAlarm:
          true, // asAlarm ensures it is loud even if media volume is low (but respects silent mode)
    );
  }
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(
              lang.isEnglish ? 'Picked Up' : 'Sudah Diambil',
              ...
              children: List.generate(_stages.length * 2 - 1, (i) {
                if (i.isOdd) {
                  ...
                  final color = isActive
                      ? _stageColor(order.status)
                      : const Color(0xFFD2B48C).withValues(alpha: 0.4);
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.inter(
                          ...
                          color: isActive
                              ? const Color(0xFF4A3022)
                              : const Color(0xFF4A3022).withValues(alpha: 0.4),
                        ),
                      ),
                    ],
                  );
