...
class LanguageProvider with ChangeNotifier {
  ...
  String tr(String id) {
    ...
    final Map<String, String> translations = {
      ...
      // Home Screen
      'Semua': 'All',
      'Mau minum & makan apa hari ini?': 'What would you like to drink & eat today?',
      ...
      // Profile Screen
      'Apakah kamu yakin ingin keluar dari akun ini?': 'Are you sure you want to log out of this account?',
      'Tentang Aplikasi': 'About App',
      'Versi 1.0.0': 'Version 1.0.0',
      'Aplikasi pemesanan kopi Ciks Coffee.\nNikmati kopi favoritmu dengan mudah!': 'Ciks Coffee ordering app.\nEnjoy your favorite coffee easily!',
      'Bahasa': 'Language',
      ...
      'Bantuan': 'Help',
      'Hubungi kami di support@cikscoffee.com': 'Contact us at support@cikscoffee.com',
      ...
      'Mulai belanja untuk menambahkan item ke keranjang.': 'Start shopping to add items to cart.',
      ...
      'Ketuk untuk pilih screenshot bukti transfer': 'Tap to select transfer proof screenshot',
      ...
      'Apakah Anda yakin sudah mengambil pesanan ini?': 'Are you sure you have picked up this order?',
